...
**Status at wrap:** everything below is **written to disk, not deployed.** Serving
depends on his push, and on a cache purge for bareyourrare.org.
...
1. **Thomas deploys** tc-ventures.ca (graph demo, contact, CSS, `resume-source.html`)
